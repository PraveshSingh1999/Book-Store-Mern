  ...
  return <div className="p-4">
    ...
    <div className="flex flex-col border-2 border-indigo-500 rounded-xl w-[600px] p-4 mx-auto shadow">
      ...
      <div className="my-4 ">
          ...
          <input type="number" value={publishYear} onChange={(e) => setPublishYear(e.target.value)} className="border-2 border-gray-500 px-4 py-2 w-full rounded-md"/>
      </div>
      <button className="p-2 bg-sky-300 my-8 rounded-md active:scale-95" onClick={handleSaveBook}>save</button>
    </div>
  </div>;
};
